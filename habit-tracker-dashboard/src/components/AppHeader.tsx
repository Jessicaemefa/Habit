...
export function AppHeader() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-slate-200 bg-[#f0f4fa]/80 shadow-sm backdrop-blur-lg dark:border-white/10 dark:bg-black/80 dark:shadow-none">
